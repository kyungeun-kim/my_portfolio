var wrap = document.querySelector(".wrap"),
    ...
    getScrollBarWidth = function () {
        ...
        return document
            ...
            .style
            .overflow = "scroll",
        (e -= document.body.clientWidth) || (e = document.body.offsetWidth - document.body.clientWidth),
        document
            .body
            .style
            .overflow = "",
...
var isMobile = function (e) {
    ...
    visaul_tween_scroll = TweenMax.to(".js-scroll-down", .5, {alpha: 0}),
    visual_tween_bg = TweenMax.to(".js-visual-back", .8, {alpha: 0}),
    ...
    project_tween_words = (new TimelineMax)
        .from(".js-proWord-1", .8, {x: "70px"})
        .from(".js-proWord-2", .8, {x: "90px"})
        .from(".js-proWord-3", .8, {x: "110px"}),
    ...
    headerScene = new ScrollMagic.Scene({triggerHook: 0, duration: "30%"}).setTween([header_tween_mail, header_tween_title, header_tween_logo, visaul_tween_scroll]),
    visualScene = new ScrollMagic.Scene({triggerHook: 0, duration: "115%"}).setTween([visual_tween_bg, visual_tween_main]),
    visualCont = document.querySelector("#visual"),
    visualPinScene = new ScrollMagic
        .Scene({triggerHook: 0, duration: "80%"})
        .setPin(visualCont)
        .on("end", function (e) {
            visualCont.classList.add("fixed")
        }),
    aboutProfileScene = new ScrollMagic.Scene({triggerElement: "#trigger-2", duration: "70%", offset: "-200%"}).setTween([about_tween_profile]),
    aboutWordScene = new ScrollMagic.Scene({triggerElement: ".work", duration: "30%", offset: "-150%"}).setTween(about_tween_connect),
    ...
    workWordScene = new ScrollMagic.Scene({triggerElement: ".blog", duration: "30%", offset: "-100"}).setTween(work_tween_connect),
    prWordScene = new ScrollMagic.Scene({triggerElement: ".pr", duration: "25%", offset: "-250%"}).setTween(pr_tween_connect),
    prScrollScene = new ScrollMagic.Scene({triggerElement: ".pr", duration: "60%", offset: 120}).setTween(pr_tween_scroll);
...
if (isMobile) 
    ...
    var project_tween_up = TweenMax.staggerFromTo(".project-list__item", 1, {
        ...
        projectScene = new ScrollMagic.Scene({triggerElement: ".project", duration: "80%", offset: "-10%"}).setTween([project_tween_up, project_tween_words]);
    controller.addScene([
        headerScene,
        visualScene,
        visualPinScene,
...
var windowLoadEvt = function () {
        isMobileSize(),
        isMobileSize()
            ? (prScrollScene.enabled(!1), prCont.style.transform = "translateX(0%)")
